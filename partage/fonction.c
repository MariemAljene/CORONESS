...
/**
* @brief To partage d'ecran .
* @param acteur
* @return Nothing
*/
void partage(acteur *acteur){
...
tempsActuel = SDL_GetTicks();
if (tempsActuel - tempsPrecedent >100){
                       if(acteur->rect2.x>320 )
{
                        acteur->rect2.x=-10+acteur->rect2.x;
                     
}
                       else if(acteur->rect2.x==340)
{
    acteur->rect2.x=640 ;                    
